...
import org.kafka_lecture.model.OrderCountComparisonStats
import org.kafka_lecture.model.PeriodStats
    ...
    fun orderCountComparison() : OrderCountComparisonStats? {
        return try {
            ...
            val changePercentage = if (prevCount > 0) {
                (changeCount.toDouble() / prevCount.toDouble()) * 100.0
