package org.kafka_lecture.stream
...
import org.kafka_lecture.model.FraudAlert
import org.kafka_lecture.model.FraudSeverity
import org.kafka_lecture.model.OrderEvent
import org.kafka_lecture.model.WindowedOrderCount
import org.kafka_lecture.model.WindowedSalesData
...
class OrderStreamProcessor(
    ...
    private val logger = LoggerFactory.getLogger(OrderStreamProcessor::class.java)
    ...
    private inline fun<reified T> createJsonSerde() : JsonSerde<T> {
        return JsonSerde<T>().apply {
            configure(mapOf(
                "spring.json.trusted.package" to "org.kafka_lecture.model",
    ...
    private fun fraudStream(orderStream : KStream<String, OrderEvent>){
        val fraudStream = orderStream.filter {_, orderEvent ->
            orderEvent.price >= BigDecimal("5000") ||
                    ...
                    orderEvent.price.multiply(BigDecimal.valueOf(orderEvent.quantity.toLong())) >= BigDecimal("1000")
